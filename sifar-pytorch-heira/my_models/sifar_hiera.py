...
class Hiera(nn.Module, PyTorchModelHubMixin):
    ...
    def __init__(
       ...
       #------------------------- Added By Sudipta ------------------------------#
        ...
        #print("Duration = ",self.duration)     # 9
        #exit(0)
        #----------------------------------------------------------------------------#
    ...
    def interpolate_pos_embed(self, x, pos_embed):
        ...
        #print("Shape of pos embed (Before) = ", pos_embed.shape)
        ...
        #print("Shape of x = ",x.shape)
        #print("Shape of pos embed (After) = ", pos_embed.shape)
        #exit(0)
        return pos_embed
    ...
    def forward(
        ...
        """
        #print("Shape of the x = ",x.shape)          #([2, 24, 224, 224]
        #exit(0)
        ...
        #print("Shape After of x = ",x.shape)
        #exit(0)
        #-------------------------------------------------------------#
